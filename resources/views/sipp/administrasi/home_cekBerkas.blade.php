                      ...
                      <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('email', $bio->email, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'purwandari@gmail.com')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('nama_lengkap', $bio->nama_lengkap, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Purwandari, M.Si.')) }}
                          </div>
                        </div>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                     <img src="{{ asset('/images/foto_pas/' . $bio->foto_pas) }}" style="width: 75%; height: 50%">
                                  </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            {{ Form::text('tempat_lahir', $bio->tempat_lahir, array('class' => 'form-control col-md-7 col-xs-12')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            {{ Form::date('tanggal_lahir', $bio->tanggal_lahir, array('class' => 'form-control col-md-7 col-xs-12')) }} 
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::select('agama', ['Islam' => 'Islam', 'Kristen' => 'Kristen', 'Katolik' => 'Katolik', 'Hindu' => 'Hindu', 'Budha' => 'Budha', 'Kong Hu cu' => 'Kong Hu cu'], $bio->agama, array('class' => 'form-control')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <div id="gender" class="btn-group" data-toggle="buttons">
                              {{-- <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default" @if($bio->gender=="Laki-Laki") class="btn btn-default active" @endif> --}}
                                {{-- {{ Form::radio('gender', 'Laki-Laki', ) }} &nbsp; Laki-Laki &nbsp; --}}
                                <input type="radio" name="gender" value="Laki-Laki" @if($bio->gender=="Laki-Laki") checked="true" @endif>&nbsp; Laki-Laki &nbsp;</input>
                              {{-- </label> --}}
                              {{-- <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default" @if($bio->gender=="Perempuan") class="btn btn-default active" @endif> --}}
                                {{-- {{ Form::radio('gender', 'Perempuan') }} Perempuan --}}
                                <input type="radio" name="gender" value="Perempuan" @if($bio->gender=="Perempuan") checked="true" @endif>Perempuan</input>
                              {{-- </label> --}}
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::select('status_menikah', ['Single' => 'Single', 'Menikah' => 'Menikah'], $bio->status_menikah, array('class' => 'form-control')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('alamat', $bio->alamat, array('class' => 'form-control col-md-7 col-xs-12')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('kota', $bio->kota, array('class' => 'form-control col-md-7 col-xs-12')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('kodepos', $bio->kodepos, array('class' => 'form-control col-md-7 col-xs-12')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('telepon', $bio->telepon, array('class' => 'form-control col-md-7 col-xs-12')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('handphone', $bio->handphone, array('class' => 'form-control col-md-7 col-xs-12')) }}
                          </div>
                        </div>
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="pendidikan1" value="Sistem Paket Murni" @if($bio->pendidikan1=="Sistem Paket Murni") checked="true" @endif>Sistem Paket Murni
                              </label>
                            </div>
                            ...
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="pendidikan2" value="Sistem Kredit Semester plus Pelatihan Psikodiagnostika" @if($bio->pendidikan2=="Sistem Kredit Semester plus Pelatihan Psikodiagnostika") checked="true" @endif>Sistem Kredit Semester plus Pelatihan Psikodiagnostika
                              </label>
                            </div>
                            ...
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="pendidikan3" value="Program S1plus Program Profesi Psikolog" @if($bio->pendidikan3=="Program S1plus Program Profesi Psikolog") checked="true" @endif>Program S1plus Program Profesi Psikolog
                              </label>
                            </div>
                            ...
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="pendidikan4" value="Program Magister Profesi Psikolog" @if($bio->pendidikan4=="Program Magister Profesi Psikolog") checked="true" @endif>Program Magister Profesi Psikolog
                              </label>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="modal fade" id="ktp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                     <img src="{{ asset('/images/foto_ktp/' . $bio->foto_ktp) }}" style="width: 75%; height: 50%">
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                  </div>
                            ...
                            <div class="modal fade" id="kta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                     <img src="{{ asset('/images/foto_kta/' . $bio->foto_kta) }}" style="width: 75%; height: 50%">
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                  </div>
                            ...
                            <div class="modal fade" id="sertifikat_sebutan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                     <img src="{{ asset('/images/sertifikat_sebutan/' . $bio->sertifikat_sebutan) }}" style="width: 75%; height: 50%">
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                  </div>
                            ...
                            <div class="modal fade" id="surat_izin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                     <img src="{{ asset('/images/surat_izin/' . $bio->surat_izin) }}" style="width: 75%; height: 50%">
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                  </div>
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="bidang1" value="Psikologi Perkembangan" @if($bio->bidang1=="Psikologi Perkembangan") checked="true" @endif>Psikologi Perkembangan
                              </label>
                            </div>
                            ...
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="bidang2" value="Psikologi Pendidikan" @if($bio->bidang2=="Psikologi Pendidikan") checked="true" @endif>Psikologi Pendidikan
                              </label>
                            </div>
                            ...
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="bidang3" value="Psikologi Klinis" @if($bio->bidang3=="Psikologi Klinis") checked="true" @endif>Psikologi Klinis
                              </label>
                            </div>
                            ...
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="bidang4" value="Psikologi Perusahaan Industri dan Organisasi" @if($bio->bidang4=="Psikologi Perusahaan Industri dan Organisasi") checked="true" @endif>Psikologi Perusahaan Industri dan Organisasi
                              </label>
                            </div>
                            ...
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="bidang5" value="Lainnya" @if($bio->bidang5=="Lainnya") checked="true" @endif>Lainnya
                              </label>
                            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('nama_praktek', $bio->nama_praktek, array('class' => 'form-control col-md-7 col-xs-12')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::text('alamat_praktek', $bio->alamat_praktek, array('class' => 'form-control col-md-7 col-xs-12')) }}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::textarea('alat_tes', $bio->alat_tes, array('class' => 'form-control col-md-7 col-xs-12', 'rows' => '5')) }}
                          </div>
                        </div>
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <div class="radio">
                              <label>
                                ...
                                <input type="radio" name="teman_praktek" value="Sendiri" @if($bio->teman_praktek=="Sendiri") checked="true" @endif>Sendiri
                              </label>
                            </div>
                            ...
                            <div class="radio">
                              <label>
                                ...
                                <input type="radio" name="teman_praktek" value="Bersama-sama dengan sejawat psikologi lainnya (Tulis nama lengkap dengan gelar rekan Anda di bawah ini )" @if($bio->teman_praktek=="Bersama-sama dengan sejawat psikologi lainnya (Tulis nama lengkap dengan gelar rekan Anda di bawah ini )") checked="true" @endif>Bersama-sama dengan sejawat psikologi lainnya (Tulis nama lengkap dengan gelar rekan Anda di bawah ini )
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <div id="divkelompok1">
                                    {{ Form::text('teman1', $bio->teman1, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Tuliskan pertama teman anda')) }}<br><br>
                                  </div>
                                  <div id="divkelompok2">
                                    {{ Form::text('teman2', $bio->teman2, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Tuliskan kedua teman anda')) }}<br><br>
                                  </div>
                                  <div id="divkelompok3">
                                    {{ Form::text('teman3', $bio->teman3, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Tuliskan ketiga teman anda')) }}<br><br>
                                  </div>
                                  <div id="divkelompok4">
                                    {{ Form::text('teman4', $bio->teman4, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Tuliskan keempat teman anda')) }}<br><br>
                                  </div>
                                  <div id="divkelompok5">
                                    {{ Form::text('teman5', $bio->teman5, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Tuliskan kelima teman anda')) }}<br><br>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <div class="checkbox">
                              <label>
                                ...
                                <input type="checkbox" name="klien1" value="Perusahaan" @if($bio->klien1=="Perusahaan") checked="true" @endif>Perusahaan
                              </label>
                            </div>
                            <div class="checkbox">
                              <label>
                                {{-- {{ Form::checkbox('klien2', 'Instansi / Lembaga Pemerintahan dan Swasta') }} Instansi / Lembaga Pemerintahan dan Swasta --}}
                                <input type="checkbox" name="klien2" value="Instansi / Lembaga Pemerintahan dan Swasta" @if($bio->klien2=="Instansi / Lembaga Pemerintahan dan Swasta") checked="true" @endif>Instansi / Lembaga Pemerintahan dan Swasta
                              </label>
                            </div>
                            <div class="checkbox">
                              <label>
                                {{-- {{ Form::checkbox('klien3', 'Orang Dewasa') }} Orang Dewasa --}}
                                <input type="checkbox" name="klien3" value="Orang Dewasa" @if($bio->klien3=="Orang Dewasa") checked="true" @endif>Orang Dewasa
                              </label>
                            </div>
                            <div class="checkbox">
                              <label>
                                {{-- {{ Form::checkbox('klien4', 'Remaja') }} Remaja --}}
                                <input type="checkbox" name="klien4" value="Remaja" @if($bio->klien4=="Remaja") checked="true" @endif>Remaja
                              </label>
                            </div>
                            <div class="checkbox">
                              <label>
                                {{-- {{ Form::checkbox('klien5', 'Anak') }} Anak --}}
                                <input type="checkbox" name="klien5" value="Anak" @if($bio->klien5=="Anak") checked="true" @endif>Anak
                              </label>
                            </div>
                            <div class="checkbox">
                              <label>
                                {{-- {{ Form::checkbox('klien6', 'Lainnya') }} Lainnya --}}
                                <input type="checkbox" name="klien6" value="Lainnya" @if($bio->klien6=="Lainnya") checked="true" @endif>Lainnya
                              </label>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="modal fade" id="bukti_iuran_sipp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                     <img src="{{ asset('/images/bukti_iuran_sipp/' . $bio->bukti_iuran_sipp) }}" style="width: 75%; height: 50%">
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                  </div>
                            ...
                            <div class="modal fade" id="bukti_pembayaran_sipp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                     <img src="{{ asset('/images/bukti_pembayaran_sipp/' . $bio->bukti_pembayaran_sipp) }}" style="width: 75%; height: 50%">
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                  </div>
